...
export function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-40 glass border-b">
              ...
              <Link
                ...
                className={`px-4 py-2 rounded-xl text-sm font-medium transition-all duration-200 ${
                  location.pathname === link.to
                    ...
                    : 'text-neutral-500 hover:text-neutral-900 hover:bg-neutral-100/80 dark:text-neutral-400 dark:hover:text-neutral-200 dark:hover:bg-neutral-800/80'
                }`}
              >
                {link.label}
              </Link>
                    ...
                    <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-neutral-900 rounded-2xl shadow-elevated border border-neutral-200/80 dark:border-neutral-800 py-2 z-20 animate-scale-in">
                      ...
                      <div className="border-t border-neutral-100 dark:border-neutral-800 mt-1 pt-1 mx-1.5">
                        <button
                          ...
                          className="flex items-center gap-2.5 px-4 py-2.5 text-sm text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 w-full rounded-lg transition-colors"
                        >
      ...
      {mobileOpen && (
        <div className="md:hidden border-t border-neutral-200/60 dark:border-neutral-800/60 bg-white/95 dark:bg-neutral-900/95 backdrop-blur-xl px-4 py-4 space-y-1 animate-fade-in">
          {publicLinks.map((link) => (
            <Link
              key={link.to}
              to={link.to}
          ...
          {user ? (
            <>
              ...
              <button
                ...
                className="block w-full text-left px-4 py-3 rounded-xl text-sm font-medium text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors"
              >
                Sign out
              </button>
            </>
