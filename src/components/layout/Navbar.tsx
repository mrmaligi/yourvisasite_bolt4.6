...
export function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-40 glass border-b dark:border-neutral-800">
      ...
      {mobileOpen && (
        <div className="md:hidden border-t border-neutral-200/60 dark:border-neutral-800 bg-white/95 dark:bg-neutral-900/95 backdrop-blur-xl px-4 py-4 space-y-1 animate-fade-in">
          {publicLinks.map((link) => (
            <Link
              key={link.to}
              to={link.to}
