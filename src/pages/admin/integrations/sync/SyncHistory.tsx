  ...
  return (
    <IntegrationsLayout>
      <div className="space-y-6">
        <div>
           <h2 className="text-xl font-semibold text-neutral-900 dark:text-white">Sync History</h2>
           <p className="text-neutral-500">Log of past synchronization jobs.</p>
        </div>
              ...
              <tbody className="divide-y divide-neutral-100 dark:divide-neutral-700">
                 {[1, 2, 3, 4, 5].map((i) => (
                    <tr key={i} className="hover:bg-neutral-50 dark:hover:bg-neutral-800/50">
                       <td className="px-6 py-4 font-mono text-neutral-500">job_{i}9283</td>
                       <td className="px-6 py-4 font-medium text-neutral-900 dark:text-white">Salesforce</td>
                       <td className="px-6 py-4 text-neutral-500">1,23{i}</td>
                       <td className="px-6 py-4"><Badge variant="success">Completed</Badge></td>
                       <td className="px-6 py-4 text-neutral-500">Oct 2{i}, 10:00</td>
                    </tr>
                 ))}
              </tbody>
           </table>
