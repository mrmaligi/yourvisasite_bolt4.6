...
export function AdminPagesV2() {
  const pages = [
    { id: 1, title: 'Home', slug: '/', status: 'Published', lastModified: 'Mar 20, 2024' },
    { id: 2, title: 'About Us', slug: '/about', status: 'Published', lastModified: 'Mar 18, 2024' },
    { id: 3, title: 'Contact', slug: '/contact', status: 'Published', lastModified: 'Mar 15, 2024' },
    { id: 4, title: 'Services', slug: '/services', status: 'Draft', lastModified: 'Mar 10, 2024' },
  ];
