              ...
              <Card key={entry.id} className="border-l-4 border-l-primary-500 overflow-hidden">
                <CardBody>
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                    <div>
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <TrackerStatusBadge stage={entry.stage} outcome={entry.outcome} />
                      </div>
                      <h3 className="font-bold text-lg text-neutral-900">{entry.visas.name}</h3>
                    </div>
                  ...
                  <TrackerTimeline
                    ...
                    applicationDate={entry.application_date}
                    decisionDate={entry.decision_date || undefined}
                  />
                </CardBody>
              </Card>
            ))}
