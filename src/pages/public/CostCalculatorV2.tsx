...
export function CostCalculatorV2() {
    ...
    <div className="min-h-screen bg-slate-50">
      <div className="bg-slate-900 py-12 px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-3xl font-bold text-white mb-4">Visa Cost Calculator</h1>
          <p className="text-slate-400">Estimate the total cost of your visa application</p>
        </div>
      </div>
