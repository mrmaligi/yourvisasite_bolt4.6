...
export function EducationAgentPartner() {
  return (
    <div className="bg-white dark:bg-neutral-900 min-h-screen transition-colors duration-300">
      <Helmet>
        <title>Education Agents | VisaBuild Resources</title>
        <meta name="description" content="Find the right course and institution." />
      </Helmet>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <h1 className="text-3xl font-bold text-neutral-900 dark:text-white mb-4">Education Agents</h1>
        <p className="text-lg text-neutral-600 dark:text-neutral-300 mb-8">Find the right course and institution.</p>
