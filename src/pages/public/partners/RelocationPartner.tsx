...
export function RelocationPartner() {
  return (
    <div className="bg-white dark:bg-neutral-900 min-h-screen transition-colors duration-300">
      <Helmet>
        <title>Relocation Services | VisaBuild Resources</title>
        <meta name="description" content="Get help moving to Australia." />
      </Helmet>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <h1 className="text-3xl font-bold text-neutral-900 dark:text-white mb-4">Relocation Services</h1>
        <p className="text-lg text-neutral-600 dark:text-neutral-300 mb-8">Get help moving to Australia.</p>
