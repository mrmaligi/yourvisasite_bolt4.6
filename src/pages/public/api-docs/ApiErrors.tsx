...
export function ApiErrors() {
  return (
    <div className="bg-white dark:bg-neutral-900 min-h-screen transition-colors duration-300">
      <Helmet>
        <title>Error Codes & Troubleshooting | VisaBuild Resources</title>
        <meta name="description" content="Handling API errors and troubleshooting." />
      </Helmet>

      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <Link to="/api-docs" className="inline-flex items-center text-primary-600 hover:text-primary-700 mb-6">
          <ArrowLeft className="w-4 h-4 mr-2" />
          Back to Api docs
        </Link>

        <h1 className="text-3xl font-bold text-neutral-900 dark:text-white mb-4">Error Codes & Troubleshooting</h1>
        <p className="text-lg text-neutral-600 dark:text-neutral-300 mb-8">Handling API errors and troubleshooting.</p>
