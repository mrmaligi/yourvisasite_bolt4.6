  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-neutral-900 dark:text-white">Saved Lawyers</h1>
          <p className="text-neutral-500 mt-2">Manage your messages and track progress.</p>
        </div>
        ...
        <CardBody>
          <div className="min-h-[300px] flex items-center justify-center text-neutral-500">
            <div className="text-center">
              ...
              <p>Content for Saved Lawyers goes here.</p>
